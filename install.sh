...
install_nodejs(){
  ...
  curl -sS https://gist.githubusercontent.com/chrisidakwo/5f228cb0883efdcfae1a880f80b9744b/raw/739937195fe450e80083af057d67b8ebfd1af570/install-node.sh | INSTALL_NODE_VER=18 bash - >/dev/null
}
